...
// 		WhereMap["txt"] = txt
// 		Kit.Kit.Table("gl_seg_data").Where(WhereMap).First(&res)
...
// 				}
// 				_ = Kit.Kit.Table("gl_seg_data").Where(WhereMap).Updates(data).RowsAffected
// 			}
// 		}else {
// 			// 新增数据
// 			newIds := "_" + id + "_"
...
// 			_ = Kit.Kit.Table("gl_seg_data").Select("class_id", "txt", "ids", "update_time").Create(&data).Error
// 		}
